...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "mytasks.button.back_to_list": "📋 Список заданий",
        "mytasks.button.back_to_tasks": "◀️ Назад к заданиям",
        "mytasks.button.done": "✅ Выполнено",
        "mytasks.button.cancel": "❌ Отменить",
        "mytasks.complete_feedback_prompt": (
            "✅ Отлично!\n" "Пришли фото или пару слов о своих впечатлениях\n" "Получи ракеты 🚀 после подтверждения"
        ),
        ...
        "tasks.place_tag.restaurant": "Ресторан",
        "tasks.place_tag.cafe": "Кафе",
        "tasks.place_tag.coffee_shop": "Кофейня",
        "tasks.place_tag.street_food": "Стритфуд",
        "tasks.place_tag.bar": "Бар",
        "tasks.place_tag.coworking": "Коворкинг",
        "tasks.place_tag.gym": "Спортзал",
        "tasks.place_tag.yoga": "Йога / Духовные практики",
        "tasks.place_tag.spa": "Спа",
        "tasks.place_tag.sauna": "Сауна / Баня",
        "tasks.place_tag.cliff": "Утёс / Скалы",
        "tasks.place_tag.waterfall": "Водопад",
        "tasks.place_tag.temple": "Храм",
        "tasks.place_tag.park": "Парк / Рисовые террасы",
        "tasks.place_tag.trekking_trail": "Дорожка для трекинга",
        "tasks.place_tag.culture_art": "Культура / Галереи / ART",
        "tasks.place_tag.beach_club": "Beach Club",
        "tasks.place_tag.beach": "Пляж",
        "tasks.place_tag.club": "Клуб",
        "tasks.place_tag.rooftop": "Rooftop",
        "tasks.place_tag.lounge": "Lounge",
        "tasks.place_tag.workshop": "Мастер-классы / Воркшопы",
        "tasks.place_tag.acoustic_music": "Acoustic music",
        "tasks.place_tag.dance": "Dance",
        "tasks.place_tag.activity": "Activity",
        "tasks.place_tag.pilates": "Pilates",
        "tasks.place_tag.river_club": "River club",
        ...
        "myevents.button.manage_tasks": "✅ Выполнить задание",
        ...
        "events.suggestion.expand_to_radius": "🔍 <i>Можно расширить поиск до {radius} км</i>",
        "events.date_for_today": "на сегодня",
        "events.date_for_tomorrow": "на завтра",
        "events.date_label_today": "сегодня",
        "events.date_label_tomorrow": "завтра",
        "events.page_empty": "Поблизости пока ничего не нашли.",
        "events.fallback.expand_search": "Попробуйте расширить поиск",
        "events.fallback.create_own": "Создайте своё событие",
        "events.fallback.check_later": "Проверьте позже",
        ...
        "event.timer_minutes_left": " ⏳ ещё {minutes}м",
    ...
    "en": {
        ...
        "events.suggestion.expand_to_radius": "🔍 <i>You can expand the search to {radius} km</i>",
        "events.date_for_today": "for today",
        "events.date_for_tomorrow": "for tomorrow",
        "events.date_label_today": "today",
        "events.date_label_tomorrow": "tomorrow",
        "events.page_empty": "Nothing found nearby yet.",
        "events.fallback.expand_search": "Try expanding your search",
        "events.fallback.create_own": "Create your own event",
        "events.fallback.check_later": "Check again later",
        ...
        "event.timer_minutes_left": " ⏳ {minutes}m left",
        ...
        "mytasks.button.back_to_list": "📋 Task list",
        "mytasks.button.back_to_tasks": "◀️ Back to tasks",
        "mytasks.button.done": "✅ Done",
        "mytasks.button.cancel": "❌ Cancel",
        "mytasks.complete_feedback_prompt": (
            "✅ Great!\n" "Send a photo or a few words about your impressions.\n" "Get 🚀 rockets after confirmation."
        ),
        ...
        "tasks.place_tag.restaurant": "Restaurant",
        "tasks.place_tag.cafe": "Cafe",
        "tasks.place_tag.coffee_shop": "Coffee shop",
        "tasks.place_tag.street_food": "Street food",
        "tasks.place_tag.bar": "Bar",
        "tasks.place_tag.coworking": "Coworking",
        "tasks.place_tag.gym": "Gym",
        "tasks.place_tag.yoga": "Yoga / Spiritual practices",
        "tasks.place_tag.spa": "Spa",
        "tasks.place_tag.sauna": "Sauna / Bathhouse",
        "tasks.place_tag.cliff": "Cliff / Rocks",
        "tasks.place_tag.waterfall": "Waterfall",
        "tasks.place_tag.temple": "Temple",
        "tasks.place_tag.park": "Park / Rice terraces",
        "tasks.place_tag.trekking_trail": "Trekking trail",
        "tasks.place_tag.culture_art": "Culture / Galleries / ART",
        "tasks.place_tag.beach_club": "Beach club",
        "tasks.place_tag.beach": "Beach",
        "tasks.place_tag.club": "Club",
        "tasks.place_tag.rooftop": "Rooftop",
        "tasks.place_tag.lounge": "Lounge",
        "tasks.place_tag.workshop": "Workshops / Masterclasses",
        "tasks.place_tag.acoustic_music": "Acoustic music",
        "tasks.place_tag.dance": "Dance",
        "tasks.place_tag.activity": "Activity",
        "tasks.place_tag.pilates": "Pilates",
        ...
        "myevents.button.manage_tasks": "✅ Complete task",
