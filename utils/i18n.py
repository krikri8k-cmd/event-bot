...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "myevents.community_world_delete_hint": "События в версии Community и World удаляются отдельно",
    ...
    "en": {
        ...
        "myevents.community_world_delete_hint": "Events in the Community and World versions are deleted separately",
