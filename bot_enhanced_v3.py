...
async def on_share(message: types.Message):
    ...
    bot_info = await bot.get_me()
    text = (
        "Навести структуру и порядок событий в групповом чате:\n"
        f"👉 t.me/{bot_info.username}?startgroup=true\n\n"
        "(Дай права админа и удаление сообщений — бот автоматически чистит свои сообщения в чате 🧹)\n\n"
        "Пригласить друзей:\n"
        f"🎉 t.me/{bot_info.username} — вместе веселей !"
    )
