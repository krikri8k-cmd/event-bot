...
async def cmd_start(message: types.Message, state: FSMContext, command: CommandObject = None):
    ...
    if chat_type == "private":
        ...
        welcome_text = (
            "Привет! 🌟 Я твой проводник по активностям рядом!\n\n"
            "📍 Что рядом: находи события и встречи в радиусе 5–20 км\n"
            "🎯 Квесты на районе: выполняй полезные задания и зарабатывай 🚀 ракеты\n"
            "➕ Создавай свои события: организуй встречи и приглашай друзей\n"
            "🔗 Поделиться: добавь бота в чат — и события будут видны только внутри вашего сообщества\n\n"
            "🚀 Начни прямо сейчас: нажми «📍 Что рядом» и отправь свою геолокацию!"
        )
