...
# @dp.callback_query(F.data == "group_hide_bot")  # Обрабатывается в group_chat_handlers.py
...
# @dp.callback_query(F.data.regexp(r"^group_hide_confirm_\d+$"))  # Обрабатывается в group_chat_handlers.py
