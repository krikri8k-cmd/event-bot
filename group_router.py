        ...
        if has_active_lists:
            ...
            if has_recent_reminder_for_this_event:
                ...
                if event_index is not None:
                    ...
                    # Если событие не найдено в списке активных, показываем список событий
                    logger.warning(f"⚠️ Событие {event_id} не найдено в списке активных событий, показываем список")
            else:
