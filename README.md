...
Python 3.12+ is not guaranteed to work due to aiogram compatibility.
...
1. **Отправьте геолокацию** командой `/set_location` или нажав кнопку "📍 События рядом"
2. **Установите радиус** командой `/radius 15` (по умолчанию 10 км)
3. **Ищите события** командой `/nearby` или кнопкой "📍 События рядом"
